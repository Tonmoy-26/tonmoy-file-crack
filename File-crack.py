...
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1mNAI

\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mIm Noob
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCmild5ucz5IDkSpvjOeO3sg")

		exit()

	else:

		os.system("https://youtube.com/channel/UCmild5ucz5IDkSpvjOeO3sg")
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [TONMOY-CP] %s|%s        '%(b,idf,pw))
